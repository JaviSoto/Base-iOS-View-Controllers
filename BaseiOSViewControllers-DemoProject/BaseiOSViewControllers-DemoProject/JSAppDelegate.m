...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    JSFirstViewController *firstVC = [[JSFirstViewController alloc] init];
    JSSecondViewController *secondVC = [[JSSecondViewController alloc] init];
    JSThirdViewController *thirdVC = [[JSThirdViewController alloc] init];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BaseiOSViewControllers_DemoProject.sqlite"];
